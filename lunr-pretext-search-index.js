...
},
{
  ...
  "number": "2.4.12",
  "title": "",
  "body": " Figure (1): two regions between the circles and , cut apart by the vertical line and swept by the angles . The line is the ray , and it meets exactly on the outer circle.     inner(t) = (cos(t), sin(t))  outer(t) = (2*cos(t), 2*sin(t))             \\left(1,\\sqrt3\\right)     \\theta = \\pi\/3  r=1  r=2  x=1  x=2  1  2                  "
},
{
...
},
{
  ...
  "number": "3.1.13",
  "title": "",
  "body": " Step 1 of the proof of : a region cut by vertical lines, with for . Counterclockwise, the bottom curve is travelled left to right and the top curve right to left; on the two vertical sides , so they contribute nothing to .     bottom(t) = (t, 0.55 + 0.30*sin(1.5*t - 0.6))  top(t) = (t, 2.35 - 0.35*sin(1.2*t + 0.4))             a  b  y = f_2(x)  y = f_1(x)   R    dy                "
},
{
...
},
{
  ...
  "number": "4.2.1",
  "title": "",
  "body": " The curve of : the boundary of the unit square, traversed once as shown.             (0,0)    (1,0)    (1,1)    (0,1)                "
},
{
  "id": "ex-hw2-wall",
  "level": "2",
...
},
{
  ...
  "number": "4.3.1",
  "title": "",
  "body": " The vector field and the curve of . The curve is traversed in the direction of the arrowhead.     F(x,y) = (0.30*y, -0.30)  circle(t) = (1.5 + 1.05*cos(t), 1.35 + 1.05*sin(t))           C  \\mathbf{F}             "
},
{
  "id": "ex-hw3-two-paths",
  "level": "2",
...
},
{
  ...
  "number": "4.4.1",
  "title": "",
  "body": " The vector field and the two paths and of . Every field vector points in the same direction; only their lengths change.     G(x,y) = (0.16*(1+x), 0.16*(1+x))           A    D    C    B                 "
},
{
...
},
{
  ...
  "number": "4.4.2",
  "title": "",
  "body": " The four shapes of . Shapes and are triangles cut off by and ; shapes and are sectors of the circle . The dashed lines are and .     arc3(t) = (2.6 + 1.3*cos(t), 4.6 + 1.3*sin(t))  arc4(t) = (7.4 + 1.3*cos(t), 4.6 + 1.3*sin(t))          1   y=r  y=x         2   x=r  y=x         3   x^2+y^2=r^2  y=x         4   x^2+y^2=r^2  y=-x              "
},
{
...
},
{
  ...
  "number": "4.5",
  "title": "Assignment 5",
  "body": " Assignment 5   Sections: and .      Consider the polar equation , .     Determine the type of symmetry that its graph possesses.      Sketch its graph. Use the polar chart of .      Set up (do not evaluate) the integral necessary for computing the area bounded by , .      A blank polar chart for . The circles are , , , and , and the spokes are spaced apart.     c1(t) = (0.5*cos(t), 0.5*sin(t))  c2(t) = (cos(t), sin(t))  c3(t) = (1.5*cos(t), 1.5*sin(t))  c4(t) = (2*cos(t), 2*sin(t))          0   \\pi\/6    \\pi\/3    \\pi\/2    2\\pi\/3    5\\pi\/6   \\pi   7\\pi\/6    4\\pi\/3    3\\pi\/2    5\\pi\/3    11\\pi\/6   0.5  1  1.5  2               Combine the following sum into one double integral. Do not evaluate the integral.       Compute the net mass of the planar object that occupies the region bounded by and , and whose mass density is given by .     "
},
{
  "id": "ex-hw5-rose",
  "level": "2",
...
},
{
  ...
  "number": "4.5.1",
  "title": "",
  "body": " A blank polar chart for . The circles are , , , and , and the spokes are spaced apart.     c1(t) = (0.5*cos(t), 0.5*sin(t))  c2(t) = (cos(t), sin(t))  c3(t) = (1.5*cos(t), 1.5*sin(t))  c4(t) = (2*cos(t), 2*sin(t))          0   \\pi\/6    \\pi\/3    \\pi\/2    2\\pi\/3    5\\pi\/6   \\pi   7\\pi\/6    4\\pi\/3    3\\pi\/2    5\\pi\/3    11\\pi\/6   0.5  1  1.5  2            "
},
{
  "id": "ex-hw5-combine",
  "level": "2",
...
},
{
  ...
  "number": "4.9.1",
  "title": "",
  "body": " The curve of : a staircase of ten unit steps from to , followed by the horizontal segment back to .           (0,0)    (10,10)    (0,10)              "
},
{
  "id": "ex-hw9-circle",
  "level": "2",
...
{
  "id": "ex-hw7o-hemisphere",
  "level": "2",
  "url": "sec-exercises-hw7-online.html#ex-hw7o-hemisphere",
  "type": "Exercise",
  "number": "1",
...
},
{
  "id": "ex-hw8o-centroid",
  "level": "2",
  "url": "sec-exercises-hw8-online.html#ex-hw8o-centroid",
  "type": "Exercise",
  "number": "1",
...
},
{
  ...
  "level": "2",
  "url": "sec-exercises-hw8-online.html#ex-hw8o-center-of-mass",
  "type": "Exercise",
  "number": "2",
...
{
  "id": "ex-hw9o-staircase",
  "level": "2",
  "url": "sec-exercises-hw9-online.html#ex-hw9o-staircase",
  "type": "Exercise",
  "number": "1",
...
},
{
  "id": "ex-hw9o-circle",
  "level": "2",
  "url": "sec-exercises-hw9-online.html#ex-hw9o-circle",
  "type": "Exercise",
  "number": "2",
...
},
{
  "id": "ex-hw9o-flux",
  "level": "2",
  "url": "sec-exercises-hw9-online.html#ex-hw9o-flux",
  "type": "Exercise",
  "number": "3",
...
},
{
  ...
  "number": "6.1.1",
  "title": "",
  "body": " The parallelogram of , with its orientation. Note the direction of the arrows.             (0,0)    (x_0,0)    (x_0,y_0)    (2x_0,y_0)                "
},
{

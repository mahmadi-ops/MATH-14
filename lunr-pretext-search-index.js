...
},
{
  ...
  "body": " Mass of a Quarter-Circle Wire          k*R\/2     A wire is the quarter circle of radius centered at , , lying in the first quadrant relative to its center. Its density is   in kilograms per meter. The total mass of the wire is kilograms.         Correct. Notice that the center never enters: shifting the wire sideways carries its density with it.       That is the coefficient from the density, not the mass. Once the density is written in terms of the parameter, the arc-length factor still has to be included.       Not quite. Parametrize the quarter circle by , , and remember that . On the wire the density simplifies considerably, and the center drops out. The complete worked solution is in the Solutions of the Assignments chapter.      "
},
{
  "id": "ex-hw2o-segment",
  "level": "2",
